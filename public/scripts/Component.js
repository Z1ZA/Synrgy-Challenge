class Component {
  ...
  render() {
    return `
    <div
      class="w-[400px] h-[600px] rounded-lg shadow-lg"
    >
      <img src="${this.image}" alt="" class="w-full h-[300px] object-cover object-center rounded-t-lg" />
      <div class="p-8 flex flex-col item-center justify-between h-[300px]">
        <h3 class="font-bold">${this.manufacture} | ${this.model}</h3>
        <h3 class="">Rp. ${this.rentPerDay} / hari</h3>
        ...
        <button class="rounded-lg p-2 font-bold border border-black hover:bg-[#54B435] hover:text-white">Pilih Mobil</button>
      </div>
    </div>
    `;
  }
